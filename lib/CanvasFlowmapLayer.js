  ...
  */
    ...
    */
        ...
        _drawAllCanvasPaths: function(renderParameters) {
            var pixelRatio = renderParameters.state.pixelRatio;
        ...
        _applyCanvasPathSymbol: function(
            ...
            ctx.lineWidth = symbolObject.lineWidth / pixelRatio;
            ctx.strokeStyle = symbolObject.strokeStyle;
            ctx.shadowBlur = symbolObject.shadowBlur / pixelRatio;
        ...
        _applyCanvasPointSymbol: function(
            ...
            ctx.arc(
                screenCoordinates[0],
                screenCoordinates[1],
                symbolObject.radius / pixelRatio,
                0,
                2 * Math.PI,
                false
            );
    ...
    */
        _convertMapPointToScreenCoordinates: function(mapPoint, rendererState) {
            ...
            screenCoordinates = [
                screenCoordinates[0] / rendererState.pixelRatio,
                screenCoordinates[1] / rendererState.pixelRatio
            ];
